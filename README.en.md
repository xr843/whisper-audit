...
# Local web interface (requires the [ui] extra): upload, monitor, and download in a browser
whisper-audit ui
```
...
number of remaining suspicious spans.
...
- [docs/lessons.md](docs/lessons.md) — 24 field-tested engineering notes: VAD
