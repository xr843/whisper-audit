...
只看关键词会把两者混为一谈。必须结合音量。

### 4. ⚠️ 定点补转 3 分钟 ≫ 全量重跑 84 分钟
...
### 8. batched 与非 batched 差 4.2 倍，且非 batched 的 GPU 在空转
